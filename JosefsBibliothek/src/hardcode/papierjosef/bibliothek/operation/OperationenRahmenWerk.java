...
public class OperationenRahmenWerk {
	 ...
	 * @param operation
	 */
	private void fuehreDokumentOperationAus(Operation<Document> operation) {
	 ...
	 * @param operation
	 */
	private void fuehreAbsatzOperationAus(Operation<Paragraph> operation) {
	 ...
	 * @param operation
	 */
	private void fuehreSatzOperationAus(Operation<Sentence> operation) {
		for(Paragraph paragraph : document.getChildElements()) {
	 ...
	 * @param operation
	 */
	private void fuehreWortOperationAus(Operation<Word> operation) {
		for(Paragraph paragraph : document.getChildElements()) {
			List<Sentence> sentences = paragraph.getChildElements();
			for(Sentence sentence : sentences) {
